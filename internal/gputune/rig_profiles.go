...
var rigProfiles = []RigProfile{
	...
	{
		ID:          "nvidia_pascal_daily",
		Label:       "NVIDIA Pascal (GTX 10xx · daily)",
		Description: "Pascal desktop: CUDA with legacy NVRTC fallbacks; smaller batches for 6–11 GB cards.",
		GPUMatch:    []string{"gtx 1060", "gtx 1070", "gtx 1080", "gtx 1050", "tesla p", "p40"},
		Env: map[string]string{
			"HACKME_RIG_PROFILE":              "nvidia_pascal_daily",
			"HACKME_GPU_BACKEND":              "cuda",
			"HACKME_WORKER_BATCH_SIZE":        "1048576",
			"GPU_CHUNK":                       "524288",
			"SEARCH_TIMEOUT_MS":               "5000",
		...
		ManualOC: RigManualOC{
			Vendor:     "NVIDIA",
			Tools:      []string{"nvidia-smi -pl", "MSI Afterburner"},
			PowerLimit: "−5…−10% PL — older drivers need reboot after update",
		},
	},
	{
		ID:          "nvidia_turing_daily",
		Label:       "NVIDIA Turing (RTX 20 / GTX 16 · daily)",
		Description: "Turing: CUDA baseline gputune profile; moderate batch for 6–8 GB cards.",
		GPUMatch:    []string{"rtx 2060", "rtx 2070", "rtx 2080", "gtx 1660", "gtx 1650", "titan rtx"},
		Env: map[string]string{
			"HACKME_RIG_PROFILE":              "nvidia_turing_daily",
			"HACKME_GPU_BACKEND":              "cuda",
			"HACKME_WORKER_BATCH_SIZE":        "2097152",
			"GPU_CHUNK":                       "1048576",
			"SEARCH_TIMEOUT_MS":               "4000",
			"HACKME_WORKER_CLAIM_COOLDOWN_MS": "12000",
			"HACKME_GPU_TEMP_PAUSE_C":         "80",
			"HACKME_GPU_TEMP_RESUME_C":        "74",
			"HACKME_DESKTOP_GPU_POOL":         "1",
		},
	...
	{
		ID:          "nvidia_hopper_hmai",
		Label:       "NVIDIA Hopper / B200 (HMAI server)",
		Description: "Datacenter Hopper/Blackwell: large batches, secure sandbox WASM headroom for vector/HMAI paths.",
		GPUMatch:    []string{"h100", "h200", "b200", "b100", "hgx"},
		Env: map[string]string{
			"HACKME_RIG_PROFILE":              "nvidia_hopper_hmai",
			"HACKME_GPU_BACKEND":              "cuda",
			"HACKME_WORKER_BATCH_SIZE":        "8388608",
			"GPU_CHUNK":                       "4194304",
			"SEARCH_TIMEOUT_MS":               "1800",
			"HACKME_WORKER_CLAIM_COOLDOWN_MS": "100",
			"HACKME_GPU_TEMP_PAUSE_C":         "85",
			"HACKME_GPU_TEMP_RESUME_C":        "78",
			"HACKME_DESKTOP_GPU_POOL":         "1",
		},
		ManualOC: RigManualOC{
			Vendor:     "NVIDIA",
			Tools:      []string{"nvidia-smi -pl", "DCGM"},
			PowerLimit: "Follow rack policy — do not exceed facility breaker",
		},
	},
	{
		ID:          "amd_rdna2_daily",
		Label:       "AMD RDNA 2 (RX 6000 · daily)",
		Description: "RDNA 2: OpenCL with validated local work size 256; watch junction on long runs.",
		GPUMatch:    []string{"rx 6950", "rx 6900", "rx 6800", "rx 6750", "rx 6700", "rx 6650", "rx 6600"},
		Env: map[string]string{
			"HACKME_RIG_PROFILE":              "amd_rdna2_daily",
			"HACKME_GPU_BACKEND":              "opencl",
			"HACKME_WORKER_BATCH_SIZE":        "4194304",
			"GPU_CHUNK":                       "2097152",
			"SEARCH_TIMEOUT_MS":               "3500",
