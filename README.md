...
[![Release](https://img.shields.io/badge/release-0.1.0--rc11k-00d1ff?style=for-the-badge)](https://hackme.tech/downloads.html)
...
| **Release** | `0.1.0-rc11k` — launch candidate: Windows installer, Linux bundle, HackMe OS ISO |
...
VERSION=0.1.0-rc11k bash scripts/release/make_release_bundle.sh
```
