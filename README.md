...
[![Release](https://img.shields.io/badge/release-0.1.0--rc14-00d1ff?style=for-the-badge&logo=semanticweb&logoColor=white)](https://hackme.tech/downloads.html)
...
| **Win / Linux / fuzz / ISO** | **rc14** | SHA256 on [downloads](https://hackme.tech/downloads.html) |
...
Release bundle: `VERSION=0.1.0-rc14 bash scripts/release/make_release_bundle.sh` — [scripts/release/README.md](scripts/release/README.md)
