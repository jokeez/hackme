...
Cryptocurrency mining involves technical and financial risk. HackMe is **experimental** release-candidate software (`0.1.0-rc10`). Not investment advice. Pool parameters (difficulty, payout policy) may change with notice on the website. Run only software you have verified.
