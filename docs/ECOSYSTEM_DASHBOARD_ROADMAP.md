...
HackMe already has an **Ecosystem** tab in `dashboard.html` (HMC live; Alpha / Orders / Shard as placeholders). This doc sequences work toward a real multi-pool UI without breaking rc11g production.
