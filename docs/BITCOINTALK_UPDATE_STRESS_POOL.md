...
`Re: [ANN] HackMe — coordinator stress test · MPS listing · rc11g Windows OpenCL`
...
**Miners**
- **Windows:** `HackMe-Setup-0.1.0-rc11g.exe` — installer, pool token preconfigured, **OpenCL** for AMD (RX 580 profile).  
