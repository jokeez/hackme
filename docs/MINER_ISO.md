...
- Build: `VERSION=0.1.0-rc11l bash scripts/release/iso/build_hackme_miner_iso.sh` (see `scripts/release/CURRENT_ISO_VERSION`)
- Win/Linux channel: `0.1.0-rc11m` (`scripts/release/CURRENT_VERSION`)
