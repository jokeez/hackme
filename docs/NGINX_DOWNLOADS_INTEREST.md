...
Track how many visitors open **downloads.html** and start the **~834 MB** `HackMe-OS-0.1.0-rc11j-amd64.iso` on the canonical VPS.
...
| `HACKME_ISO_SUBPATH` | `HackMe-OS-0.1.0-rc11j-amd64.iso` |
