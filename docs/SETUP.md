...
2. Verify: `bash scripts/tests/verify_hackme_iso.sh /path/to/HackMe-OS-0.1.0-rc11o-amd64.iso` (ISO channel; Win/Linux installer is **0.1.0-rc11p** — see `scripts/release/CURRENT_VERSION`)  
