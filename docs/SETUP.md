...
2. Verify: `bash scripts/tests/verify_hackme_iso.sh /path/to/HackMe-OS-0.1.0-rc11s-amd64.iso` (ISO channel **0.1.0-rc11s** — see `scripts/release/CURRENT_ISO_VERSION`)  
