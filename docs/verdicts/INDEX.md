...
| [../HACKME_RC14.md](../HACKME_RC14.md) | **Current channel rc14** — desktop/pool UX + B1–B5 security hotfix |
...
Win/Linux channel: `scripts/release/CURRENT_VERSION` → **0.1.0-rc14**. ISO channel: `scripts/release/CURRENT_ISO_VERSION` → **0.1.0-rc14**.
