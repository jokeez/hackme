...
**Release:** `0.1.0-rc11p` (Win/Linux **rc11p** · ISO **rc11o** until rebuild) · **Pool:** `https://hackme.tech/pool/coordinator`  
...
| ISO on CDN | SHA256 from `SHA256SUMS-iso.txt` on rc11o dist + GRUB “HackMe OS” (see below) | ☐ |
...
```bash
# After download:
sha256sum HackMe-OS-0.1.0-rc11o-amd64.iso
# Must match SHA256SUMS-iso.txt on https://hackme.tech/dist/release_0.1.0-rc11o/
