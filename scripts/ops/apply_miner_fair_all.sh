...
if [[ -f "$DESKTOP_ENV" ]]; then
  ...
  set_kv HACKME_WORKER_BATCH_SIZE 16777216
  set_kv HACKME_WORKER_CLAIM_TIMEOUT 90s
  set_kv HACKME_WORKER_SUBMIT_TIMEOUT 120s
  set_kv HACKME_WORKER_CLAIM_COOLDOWN_MS 100
  set_kv HACKME_GPU_BACKEND cuda
  set_kv HACKME_DESKTOP_GPU_POOL 1
  set_kv HACKME_POOL_DIRECT 1
  set_kv HACKME_POOL_COORDINATOR_URL "http://132.243.112.100:18083"
  set_kv COORD_URL "http://132.243.112.100:18083"
  set_kv SEARCH_TIMEOUT_MS 12000
  set_kv GPU_CHUNK 4194304
