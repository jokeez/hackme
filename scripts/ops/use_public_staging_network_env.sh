...
export HACKME_CANONICAL_CHAIN_URL="${HACKME_CANONICAL_CHAIN_URL:-http://hackme-vps:18080}"
export HACKME_POOL_COORDINATOR_URL="${HACKME_POOL_COORDINATOR_URL:-http://hackme-vps:18081}"
export HACKME_P2P_PEERS="${HACKME_P2P_PEERS:-http://hackme-vps:18080}"
