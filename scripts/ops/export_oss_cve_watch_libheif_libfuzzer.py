...
<title>HackMe · OSS CVE Watch · Day {day}/14 · libheif · libFuzzer</title>
<meta name="description" content="OSS CVE Watch day {day}: libheif libFuzzer — {iters:,} executions, {verdict}, corpus {corp}."/>
<link rel="canonical" href="https://hackme.tech/reports/oss-cve-watch-libheif/day{day:02d}.html"/>
...
<h1>libheif · libFuzzer depth</h1>
<p style="font-size:.85rem;color:#9eb0c8">HEIF/AVIF file_fuzzer decode · coverage-guided ASAN · {hours:.1f}h operator session</p>
...
<h2>Target · <code>libheif</code></h2>
<p><code>https://github.com/strukturag/libheif</code></p>
...
Reproduce: <code>bash scripts/ops/run_oss_libfuzzer_session.sh</code> (corpus persists in <code>reports/oss-cve-libfuzzer/libheif/corpus/</code>).
</div>
<footer>
...
<meta charset="utf-8"/>
<meta name="viewport" content="width=device-width,initial-scale=1"/>
<title>HackMe · OSS CVE Watch · libheif</title>
<meta name="description" content="OSS CVE Watch — 14 days on libheif. Day 1 mutation, Day 2+ libFuzzer depth."/>
<link rel="canonical" href="https://hackme.tech/reports/oss-cve-watch-libheif/"/>
<link rel="preconnect" href="https://fonts.googleapis.com"/>
<link href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;600;700&family=Space+Grotesk:wght@500;700&display=swap" rel="stylesheet"/>
<style>
:root{{--neon:#00d1ff;--matrix:#39ff14;--warn:#ffb020;--bg:#05080f;--card:rgba(0,0,0,.45)}}
...
<div class="wrap">
<section class="hero">
<p class="tag">one repo · 14 days · libheif · Jul 2026</p>
<h1>OSS CVE Watch · libheif</h1>
<p style="font-size:.85rem;color:#9eb0c8;margin-top:1rem"><strong>{completed}/14</strong> days published ·
<a href="https://github.com/strukturag/libheif" style="color:var(--neon)">libheif/libheif</a> · HEIF/AVIF file_fuzzer decode</p>
</section>
...
def main() -> int:
    ...
    root = repo_root()
    out_dir = root / "web" / "site" / "reports" / "oss-cve-watch-libheif"
    out_dir.mkdir(parents=True, exist_ok=True)

    (out_dir / f"day{day:02d}.html").write_text(day_html(day, session, rollup))

    meta_path = out_dir / "meta.json"
    meta: dict = {"target": "libheif", "series_days": 14, "days": []}
